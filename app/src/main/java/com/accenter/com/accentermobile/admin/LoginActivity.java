...
public class LoginActivity extends AppCompatActivity {
    ...
    public final static String TAG_LIKE = "suka";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        builder.setMessage("Hanya untuk admin aplikasi yang mengakses PANEL ADMIN!!!");
        ...
        builder.setNegativeButton("KABUR", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(getApplicationContext(), "Bhahahahh dia kabur!!", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
        builder.show();
            ...
            public void onClick(View v) {
                ...
                if (username.trim().length() > 0 && password.trim().length() > 0) {
                    if (conMgr.getActiveNetworkInfo() != null
                        ...
                        Toast.makeText(getApplicationContext() ,"Tidak ada Jaringan Internet om", Toast.LENGTH_LONG).show();
                    }
                } else {
