...
public class DaftarActivity extends AppCompatActivity {
    ...
    private String url = Server.URL_REGISTER + "daftar.php";
    ...
    private void checkRegister(final String username, final String password, final String confirm_password) {
        ...
        pDialog.setMessage("Proses Daftar ...");
        showDialog();
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        Log.e("Sukses Mendaftar!", jObj.toString());
    ...
    private void konfirmasi(){
        Toast.makeText(this,"Sukses Mendaftar Admin Aplikasi",Toast.LENGTH_SHORT).show();
    }
